...
To create a single font for typesetting the text, accents, symbols, and sigla, it's possible to merge the glyphs from Riverrun into another font (e.g. using  'Element > Merge Font' in FontForge). The font Blue Lagoon was created by merging [[https://github.com/CatharsisFonts/Cormorant][Cormorant]] with Riverrun.

[[file:img/blue-lagoon-specimen.jpg]]
...
ad bin “provoked” ay /\ fork, of a grave Brofésor; ath é’s Bréak
— fast — table; ; actitely professionally piquéd, to = introdtice a
notion of time [upon a plane (?) st’ ’fac’e’] by ptinct! ingh oles
