...
I'm aware of two previous fonts, which both use ASCII overloading (i.e. LATIN & SIGLUM are indistinguishable) to represent the sigla. Fweet Figla contains 18 sigla [[[https://fweet.org/fweet/pages/fw_font.php][ref]]], and Ian Gunn's [[https://www.riverrun.org.uk/wake/index.html][Wake typeface]] includes many more.

The primary advantage of unicode encoding is to enable a single font to typeset the text, accents and various sigla. It also enables the sigla to be located in the text (e.g. search by character) and uniquely identified (typographically at least).
...
[[file:img/WAKE2_font.png]]
 ...
 https://www.finnegansweb.com/wiki/index.php/Help:Contents

scans & https://finnegansweb.com/wiki/index.php/Sigla
...
- [[https://www.finnegansweb.com/wiki/index.php?title=Sigla&oldid=13612]]
